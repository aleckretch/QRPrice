...
public class ItemLookupSample {
     ...
     */
    private static final String AWS_ACCESS_KEY_ID = "AKIAJGVKAY3NNTB62TFQ";

    /*
     * Your AWS Secret Key corresponding to the above ID, as taken from the AWS
     * Your Account page.
     */
    private static final String AWS_SECRET_KEY = "VnE2vygnz2RXaiDA9ZIKbgx/kcL2ZRphnCxXVIw0";
    ...
    private static String fetchTitle(String requestUrl) {
        ...
        try {
            ...
            Node titleNode = doc.getElementsByTagName("Harry Potter").item(0);
